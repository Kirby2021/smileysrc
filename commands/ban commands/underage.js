...
module.exports = {
    name: 'underage',
    description: 'Ban a member for being underage.',
    ...
    async run (bot, message, args) {
        ...
        const reason = "Being under 13 years old. To stay in the server you have to be atleast 13 years old as that includes in the Discord TOS";
